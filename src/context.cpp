...
void Context::Render() {
	...
	m_program->SetUniform("light.position", m_light.direction);
	...
	auto lightModelTransform = glm::translate(glm::mat4(1.0), m_light.direction) 
	...
	m_program->Use();
	m_program->SetUniform("lightPos", m_light.direction);
...
bool Context::Init() {
	...
	if (!vertShader || !fragShader) {
		SPDLOG_ERROR("shaders load fail");
		return false;
	}
	...
	// if (!m_program) {
	// 	SPDLOG_ERROR("program load fail");
	// 	return false;
	// }
