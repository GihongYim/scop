...
bool Context::Init() {
	...
	ShaderPtr vertShader = Shader::CreateFromFile("./shader/vertex_shader.vs", GL_VERTEX_SHADER);
	ShaderPtr fragShader = Shader::CreateFromFile("./shader/fragment_shader.fs", GL_FRAGMENT_SHADER);
